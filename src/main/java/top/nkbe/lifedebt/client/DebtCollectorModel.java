...
public final class DebtCollectorModel extends EntityModel<LivingEntityRenderState> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		root.addChild("right_arm", ModelPartBuilder.create()
			...
			ModelTransform.origin(-6.0f, 6.0f, 0.0f));
		...
		root.addChild("tail_left", ModelPartBuilder.create()
			...
			ModelTransform.origin(-1.0f, 13.0f, 0.0f));
	...
	public void setAngles(LivingEntityRenderState state) {
		...
		head.yaw = state.relativeHeadYaw * 0.011f;
		head.pitch = 0.2f + state.pitch * 0.011f;
